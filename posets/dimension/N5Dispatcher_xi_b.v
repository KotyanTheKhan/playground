...
From Dimension Require Import N5Dispatcher_xi_c.
From ZornsLemma Require Import FiniteTypes EnsemblesExplicit.
From Stdlib Require Import Ensembles Finite_sets Finite_sets_facts.

(** Second sub-block of micro-case (xi): 3rd-edge cases (g) = (s,p),
    (h) = (t,p), (i) = (q,s), (j) = (q,t), (k) = (s,q), (l) = (t,q).
    If none fire, delegates to subcase_c with accumulated negations. *)
Lemma n5_dispatcher_microcase_xi_subcase_b :
...
Proof.
  intros B R2 HR2 Hcard Hnonantichain Hinc_ex p q r s t
    ...
    apply (@n5_dispatcher_microcase_xi_subcase_c B R2 HR2 Hcard
