...
From Dimension Require Import N5Dispatcher_vii_c.
From ZornsLemma Require Import FiniteTypes EnsemblesExplicit.
From Stdlib Require Import Ensembles Finite_sets Finite_sets_facts.

(** Second sub-block of micro-case (vii): 3rd-edge cases (g) = (t,r),
    (h) = (r,s), (i) = (q,t), (j) = (s,p), (k) = (p,t), (l) = (t,p).
    If none fire, delegates to subcase_c. *)
Lemma n5_dispatcher_microcase_vii_subcase_b :
...
Proof.
  intros B R2 HR2 Hcard Hnonantichain Hinc_ex p q r s t
    ...
    apply (@n5_dispatcher_microcase_vii_subcase_c B R2 HR2 Hcard
