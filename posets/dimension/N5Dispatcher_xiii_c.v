...
(** Third sub-block of micro-case (xiii): 3rd-edge cases (m) = (t,s),
    (n) = (t,r), (o) = (s,t), (p) = (r,t), (q) = (s,r), (r) = (r,s),
    plus the final exfalso using all 18 accumulated negations. *)
Lemma n5_dispatcher_microcase_xiii_subcase_c :
  forall {B : Type} (R2 : B -> B -> Prop) `{HR2 : IsPoset B R2}
    ...
    (HnRsq_third : ~ R2 s q) (HnRrq_third : ~ R2 r q),
