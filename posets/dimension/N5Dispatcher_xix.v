...
From Dimension Require Import N5Dispatcher_xix_a.
...
(** Micro-case (xix) of the second-edge cascade inside the residual handler:
    ...
    contains the 3-chain [t < p < q] plus isolated [r], [s].  If no fourth
    ...
    split across N5Dispatcher_xix_a.v (cases a-g), _xix_b.v (h-l) and
    _xix_c.v (m-q + final exfalso); this file is the thin wrapper. *)
...
Proof.
  ...
  - apply (@n5_dispatcher_microcase_xix_subcase_a B R2 HR2 Hcard
