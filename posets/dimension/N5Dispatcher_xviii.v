...
From Dimension Require Import N5Dispatcher_xviii_a.
...
(** Micro-case (xviii) of the second-edge cascade inside the residual handler:
    ...
    contains the 3-chain [s < p < q] plus isolated [r], [t].  If no fourth
    ...
    split across N5Dispatcher_xviii_a.v (cases a-g), _xviii_b.v (h-l) and
    _xviii_c.v (m-q + final exfalso); this file is the thin wrapper. *)
...
Proof.
  ...
  - apply (@n5_dispatcher_microcase_xviii_subcase_a B R2 HR2 Hcard
