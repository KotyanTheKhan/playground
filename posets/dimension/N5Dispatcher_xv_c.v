...
(** Third sub-block of micro-case (xv): 4th-edge cases (m) = (r,t),
    (n) = (t,r) — disjoint 2-chain (HnCC); plus antisymmetry cases
    (o) = (q,p), (p) = (s,q), (q) = (s,p); plus the final exfalso
    using all 17 accumulated negations. *)
Lemma n5_dispatcher_microcase_xv_subcase_c :
