...
From Dimension Require Import N5Dispatcher_v_a.
...
(** Micro-case (v) of the second-edge cascade inside the residual handler:
    ...
    [s] — contradicting [HnDisj].  The third-edge cascade is split across
    N5Dispatcher_v_a.v (cases a-f), _v_b.v (g-l) and _v_c.v (m-r +
    residual routing); this file is the thin wrapper. *)
...
Proof.
  ...
  - (* A third strict edge exists - delegate to subcase_a. *)
    apply (@n5_dispatcher_microcase_v_subcase_a B R2 HR2 Hcard
