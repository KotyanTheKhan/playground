(** edge_count_5 = 5 case for the n=5 dispatcher.

    FOCUSED ADMIT (2026-05-29): every 5-element poset with exactly 5
    ...
    template does NOT scale here (C(25,5) edge-sets is infeasible for
