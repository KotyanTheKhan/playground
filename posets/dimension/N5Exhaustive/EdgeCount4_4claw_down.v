(** 4-claw-down case for [edge_count_5 = 4].

    Class 20: root with 4 parents.  Edges l1<r, l2<r, l3<r, l4<r
    (no other edges).  Calls [n5_4claw_down_two_realizer]. *)
...
Section EdgeCount4_4claw_down.
  Context {B : Type}.
  Context (R2 : B -> B -> Prop) `{HR2 : IsPoset B R2}.

  Lemma four_claw_down_closure :
  ...
  Proof.
    intros a b c d e r l1 l2 l3 l4
           ...
           HR1 HR2' HR3 HR4
           x y HRxy Hxy_neq.
    assert (Hsi1 : strict_indicator R2 l1 r = 1)
      by (apply strict_indicator_eq_1; [assumption | intro He; apply Hrl1; symmetry; exact He]).
    assert (Hsi2 : strict_indicator R2 l2 r = 1)
      by (apply strict_indicator_eq_1; [assumption | intro He; apply Hrl2; symmetry; exact He]).
    assert (Hsi3 : strict_indicator R2 l3 r = 1)
      by (apply strict_indicator_eq_1; [assumption | intro He; apply Hrl3; symmetry; exact He]).
    assert (Hsi4 : strict_indicator R2 l4 r = 1)
      by (apply strict_indicator_eq_1; [assumption | intro He; apply Hrl4; symmetry; exact He]).
  ...
  Lemma n5_edge_count_4_4claw_down :
  ...
  Proof.
    intros Hcard a b c d e
           ...
           Hrl1 Hrl2 Hrl3 Hrl4 Hl12 Hl13 Hl14 Hl23 Hl24 Hl34
           HR1 HR2' HR3 HR4.
    (* 4claw_down_two_realizer signature: a is the root, b/c/d/e are leaves below. *)
    ...
    right.
    destruct (four_claw_down_closure a b c d e r l1 l2 l3 l4
                Hab Hac Had Hae Hbc Hbd Hbe Hcd Hce Hde Hcov Hec
                Hrl1 Hrl2 Hrl3 Hrl4 Hl12 Hl13 Hl14 Hl23 Hl24 Hl34
