(** M-shape case for [edge_count_5 = 4].

    Class 17: edges (b,a),(b,c),(d,c),(d,e).  Two V-shapes sharing
    target c.  b and d are bottoms; a, c, e are tops.
    Calls [n5_M_shape_two_realizer]. *)
...
Section EdgeCount4_M_shape.
  Context {B : Type}.
  Context (R2 : B -> B -> Prop) `{HR2 : IsPoset B R2}.

  Lemma M_shape_closure :
  ...
  Proof.
    ...
    right.
    destruct (M_shape_closure a b c d e alpha beta gamma delta eps
                Hab Hac Had Hae Hbc Hbd Hbe Hcd Hce Hde Hcov Hec
                H1 H2 H3 H4 H5 H6 H7 H8 H9 H10
                HRba HRbc HRdc HRde x y HRxy Hxy_neq)
