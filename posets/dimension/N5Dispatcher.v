(** n = 5 dispatcher cascade.
    ...
    - [n5_dispatcher_microcase_ii] .. [n5_dispatcher_microcase_vi] —
      Qed-closed handlers for the second-edge cascade branches (r, s),
      (s, r), (r, t), (t, r), and (s, t) respectively.  Extracted from
      the dispatcher to split its giant Qed into independently-
      compilable proof terms.  Partial progress on the broader
      refactor: micro-cases (vii)–(xix) of the same second-edge cascade
      remain inline inside [n5_nonantichain_nonchain_two_realizer] and
