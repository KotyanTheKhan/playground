...
From Dimension Require Import N5Dispatcher_xiv_a.
...
(** Micro-case (xiv) of the second-edge cascade inside the residual handler:
    ...
    split across N5Dispatcher_xiv_a.v (cases a-f), _xiv_b.v (g-l) and
    _xiv_c.v (m-q + final exfalso); this file is the thin wrapper. *)
...
Proof.
  ...
  - apply (@n5_dispatcher_microcase_xiv_subcase_a B R2 HR2 Hcard
