...
From Dimension Require Import N5Dispatcher_ix_a.
...
(** Micro-case (ix) of the second-edge cascade inside the residual handler:
    ...
    N5Dispatcher_ix_a.v (cases a-f), _ix_b.v (g-l) and _ix_c.v (m, n, o,
    p, q, s + final exfalso); this file is the thin wrapper. *)
...
Proof.
  ...
  - (* A third strict edge exists - delegate to subcase_a. *)
    apply (@n5_dispatcher_microcase_ix_subcase_a B R2 HR2 Hcard
