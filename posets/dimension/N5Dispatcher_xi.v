...
From Dimension Require Import N5Dispatcher_xi_a.
...
(** Micro-case (xi) of the second-edge cascade inside the residual handler:
    ...
    split across N5Dispatcher_xi_a.v (cases a-f), _xi_b.v (g-l) and
    _xi_c.v (m-r + final exfalso); this file is the thin wrapper. *)
...
Proof.
  ...
  destruct (classic (exists a b : B,
            ...
            ~ (a = p /\ b = q) /\ ~ (a = r /\ b = q)))
    as [Hthird | Hno_third].
  - apply (@n5_dispatcher_microcase_xi_subcase_a B R2 HR2 Hcard
