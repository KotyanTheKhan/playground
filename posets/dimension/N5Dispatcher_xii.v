...
From Dimension Require Import N5Dispatcher_xii_a.
...
(** Micro-case (xii) of the second-edge cascade inside the residual handler:
    ...
    split across N5Dispatcher_xii_a.v (cases a-f), _xii_b.v (g-l) and
    _xii_c.v (m-r + final exfalso); this file is the thin wrapper. *)
...
Proof.
  ...
  destruct (classic (exists a b : B,
            ...
            ~ (a = p /\ b = q) /\ ~ (a = s /\ b = q)))
    as [Hthird | Hno_third].
  - apply (@n5_dispatcher_microcase_xii_subcase_a B R2 HR2 Hcard
