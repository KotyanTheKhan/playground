...
From Dimension Require Import N5Dispatcher_vii_a.
...
(** Micro-case (vii) of the second-edge cascade inside the residual handler:
    ...
    [r] — contradicting [HnDisj].  The third-edge cascade is split across
    N5Dispatcher_vii_a.v (cases a-f), _vii_b.v (g-l) and _vii_c.v
    (m-r + residual routing); this file is the thin wrapper. *)
...
Proof.
  ...
  - (* A third strict edge exists - delegate to subcase_a. *)
    apply (@n5_dispatcher_microcase_vii_subcase_a B R2 HR2 Hcard
