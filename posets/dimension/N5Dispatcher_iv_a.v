...
From Dimension Require Import N5Dispatcher_iv_b.
From ZornsLemma Require Import FiniteTypes EnsemblesExplicit.
From Stdlib Require Import Ensembles Finite_sets Finite_sets_facts.

(** First sub-block of micro-case (iv): 3rd-edge cases (a) = (q,s),
    (b) = (s,p), (c) = (t,s), (d) = (s,r), (e) = (p,s), (f) = (s,q).
    If none fire, delegates to subcase_b with the 6 derived negations. *)
Lemma n5_dispatcher_microcase_iv_subcase_a :
...
Proof.
  intros B R2 HR2 Hcard Hnonantichain Hinc_ex p q r s t
    ...
    apply (@n5_dispatcher_microcase_iv_subcase_b B R2 HR2 Hcard
