...
_42 entries (11 DEF, 9 FACT, 19 THM, 2 ALG, 1 CONJ). Auto-generated — do not edit between the markers._
...
2. [Standard examples & lower bounds](#2-standard-examples--lower-bounds)
...
3. [Upper bounds & inequalities](#3-upper-bounds--inequalities)
...
7. [Dimension and chromatic number](#7-dimension-and-chromatic-number)
...
8. [Application: logical clocks (project goal)](#8-application-logical-clocks-project-goal)
