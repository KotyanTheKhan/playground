...
Proof.  { intros.
 ...
 Proof. { intros.
  ...
  Proof. { intros.
           ...
           assert (H3: m<=n).
           {  destruct H as [_ H_e1_largest].  eapply H_e1_largest. apply H0. exact H1. exact H2.  }

           assert (H4: n<=m).
           { destruct H0 as [_ H_e2_largest]. eapply H_e2_largest. apply H. exact H2. exact H1. }
